...
var _$1={startsWith:_startsWith,get:_get,find:_find,isEqual:_isEqual,isString:_isString,includes:_includes,assignIn:_assignIn,map:_map,forEach:_forEach,reduce:_reduce,remove:_remove,isEmpty:_isEmpty,overSome:_overSome},removeLodashImports=function(a){return{ImportDeclaration:function ImportDeclaration(b){var c=b.node.source.value;if(_$1.startsWith("lodash-es")(c))throw b.buildCodeFrameError("lodash-magic-import plugin is completely useless with lodash-es");var d=_$1.overSome([_$1.startsWith("lodash/fp/"),_$1.isEqual("lodash/fp")])(c),e=_$1.overSome([_$1.startsWith("lodash/"),_$1.isEqual("lodash")])(c)&&!d;if(a[0]=a[0]||e, a[1]=a[1]||d, a[0]&&a[1])throw b.buildCodeFrameError("Mixing lodash and lodash/fp is prohibited");(e||d)&&b.remove();}}},checkProhibitedFunction=function(a,b){if(_$1.includes(b)(["chain","tap","thru"]))throw a.buildCodeFrameError("Using _.".concat(b," method is prohibited"))},replaceAndGet=function(a,b){return{Identifier:function Identifier(c){if("_"===_$1.get("node.name")(c)){var d=c.findParent(function(a){return a.isMemberExpression()}),e=_$1.get("node.property.name")(d);if(e)if(checkProhibitedFunction(c,e), _$1.includes(e)(functions))d.replaceWith(a.identifier("_".concat(e))), _$1.includes(e)(b)||b.push(e);else throw d.buildCodeFrameError("Unknown lodash method _.".concat(e));var f=c.findParent(function(a){return a.isCallExpression()});if("_"===_$1.get("node.callee.name")(f))throw f.buildCodeFrameError("Using Seq methods is prohibited")}},VariableDeclaration:function VariableDeclaration(a){var b=_$1.remove(function(a){return"_"===a.id.name})(a.node.declarations);_$1.isEmpty(b)?a.remove():a.node.declarations=b;}}},importLodashDeclaration=function(a,b,c){return a.importDeclaration([a.importDefaultSpecifier(a.identifier("_".concat(c)))],a.stringLiteral("lodash/".concat(b?"fp/":"").concat(c)))},cachedRequire=function(a,b,c){return a.variableDeclaration("const",[a.variableDeclarator(a.identifier("_"),a.callExpression(a.memberExpression(a.callExpression(a.identifier("require"),[a.stringLiteral("lodash-magic-cache")]),a.identifier(b?"fp":"lodash"),!1),[_$1.isString(c)?a.identifier(c):a.arrayExpression(_$1.map(a.stringLiteral)(c))]))])};function Plugin(a){var b=a.types;return{visitor:{Program:function Program(a,c){var d=_$1.find(b.isModuleDeclaration)(a.hub.file.ast.program.body);if(d){var g=_$1.get("opts.cache")(c),h=[],i=[!1,!1],j=_$1.reduce(_$1.assignIn,{})([removeLodashImports(i),replaceAndGet(b,h)]);a.traverse(j);var e=i[0],f=i[1];if(!e&&!f&&!_$1.isEmpty(h))throw a.buildCodeFrameError("Add a lodash or lodash/fp import");var k=function(b){return a.unshiftContainer("body",b)};if(g)k(cachedRequire(b,f,h));else{var l=_$1.map(function importNodeFor(a){return importLodashDeclaration(b,f,a)})(h);_$1.forEach(k)(l);}}a.stop();}}}}
